...
# Enter the folder path containing the TSV file/files
...
# the path for the output folder and the name that you want for your new subset file
...
# filter rows with dates that you want
...
# the path of the csv file that contain the stringency index and number of cases and death
...
# Convert the 'date' column to date format (without time) for merging
...
# Calculate the normalized columns
...
# Calculate the sum of 0 , 1 tweets count and inser it
...
# All columns names :
    #'day', 'stringency_index', 'reproduction_rate', 'gdp_per_capita','extreme_poverty', 'new_cases',
    #'tweet_count_-1', 'tweet_count_0', 'tweet_count_1', 'sum_tweet_counts',
    #'normalized_tweet_count_-1', 'normalized_tweet_count_0', 'normalized_tweet_count_1', 'normalized_sum_tweet_count_0_and_1',
    #'tweet_count_-1_smoothed', 'tweet_count_0_smoothed', 'tweet_count_1_smoothed', 'sum_tweet_counts_smoothed',
    #'normalized_tweet_count_-1_smoothed', 'normalized_tweet_count_0_smoothed', 'normalized_tweet_count_1_smoothed', 'normalized_sum_tweet_count_0_and_1_smoothed'
